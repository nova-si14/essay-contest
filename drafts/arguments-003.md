...
For the first time in recorded history, we have real-time tools to detect financial bubbles as they form. The dot-com bubble of the 1990s, the aviation bubble of the early twentieth century, the railway manias of the 1840s — all of these occurred before the invention of liquid prediction markets and the systematic study of calibrated forecasting. The electricity bubble that Goldfarb and Kirsch trace with such care in *Bubbles and Crashes* began in 1879; Polymarket was founded in 2020. If any of those historical bubbles were forming today, we would have Metaculus forecasters and Polymarket traders pricing their probability in real time. So here is a genuinely novel question: we have a candidate bubble forming right now, in AI. What do those tools say? Do they catch it? The answer turns out to be more interesting than you might expect.

***

With this essay, which is putatively a book review, I am actually making a broader argument that the "AI revolution" will be an important but "normal" technology like electricity, aviation, or the internet (i.e. one that will revolutionize society), but not an "abnormal" technology like the Industrial Revolution or the Agricultural Revolution (i.e. one that will "transform" society by triggering a Hanson-style growth mode transition), let alone a technology that will bring us the "singularity" (i.e. one that will definitively "take over" the world).
...
The exception Jones carefully notes: in fields where cognition constitutes nearly everything — pure mathematics, software design — AI *can* multiply progress enormously. These domains have no physical experiments, no clinical trials, no synthesis requirements. Here, a superintelligent system could genuinely accelerate the field by factors that look more like Alexander's abnormal scenario. But mathematics and software, while economically important, are not large enough fractions of total economic output to move the aggregate growth rate from its current fifteen-year doubling time to weeks. We will likely see dramatic AI-driven progress in those domains without the economy as a whole undergoing a Hanson-style mode transition.
...
What does this tell us? Prediction markets and superforecasters are considerably more conservative than the prevailing AI narrative implies. A 2030 median for transformative AI is not a screaming endorsement of the Hanson fourth-mode scenario arriving this decade. Eighty-six percent of Polymarket participants do not expect AGI by the end of this year.

This largely resolves the tension in the secondary hypothesis: I do not need to choose between "superforecasters are biased" and "superforecasters agree with me." The data suggests they are reasonably skeptical — their forecasts are more consistent with a normal-technology view (significant impact, but not imminent mode transition) than with Alexander's two-to-ten-year superintelligence timeline.
