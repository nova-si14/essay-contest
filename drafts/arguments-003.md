...
-> This is literally an admission that AGI will be achieved and a defeat of my argument will be achieved: (1) I argue that algorithmic progress alone can't reach us to AGI, we need experiments (who can know that?) (2) I argue that algorithmic progress can reach AGI but not Superintelligence, and such a world will still be bottlenecked and grow at 2% per year and AGI won't takeover or (3) I argue that a world with AGI or Superintelligence will still be bottlenecked and grow at 2% per year and ASI won't takeover.
-> Also the AI 2027 project have an scenario where there are bottlenecks but AI is so fast that it still accelerates enormously towards superintelligence, partly thanks to "research taste". What if (1) even if AI is fast, it can't actually increase AI research because it can only repeat what has already been discovered? (some evidence against that with seeming advances in math by AI) (2) even if AI is fast, it actually slows down AI research because it brings down to average the research taste of the best AI researchers (some evidence of that with senior programmers experience with AI tools). (3) Even if we create a country of geniuses in a datacenter, their skill will be normally distributed and the "average" research taste will dominate over the tails (the top researchers) (I always wondered this).

But mathematics and software, while economically important, are not large enough fractions of total economic output to move the aggregate growth rate from its current fifteen-year doubling time to weeks. We will likely see dramatic AI-driven progress in those domains without the economy as a whole undergoing a Hanson-style mode transition. -> I believe this will happen. As I understand it's basically the theory of the winners of 2025 econ prize: Technological progress accelerates greatly some economic fields, but the economy is bottlenecked on the others, so that growth remains at 2% per yer globally.
